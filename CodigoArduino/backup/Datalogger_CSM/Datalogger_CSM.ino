...
const int time_interval = 2; //Intervalo de tiempo para la toma de datos
int ciclo = 0; 
...
void tomaDatos() {
  ...
  float vol_panel = analogRead(A2)*(4.73)*(0.0049)*0.5;
  ...
  if(first_run){
    finalString_first = String(day(tiempo))+ "," + String(month(tiempo))+ "," + String(hour(tiempo))+ "," + String(minute(tiempo)) + "," + "-1" + "," + String(int(vol_bat)) + "," + "1" + "," + String(direccion) + "," + "1" + "," + String(int(vol_panel)) +  ";";
